...
//  ----------------------------------------------------------------------------
    ...
    *
    * @param avsResultCode String containing the vpc_AVSResultCode
    * @return description String containing the appropriate description
    */
    private String displayAVSResponse(String avsResultCode) {

        String result = "";
        if (avsResultCode != null || avsResultCode.length() == 0) {

            if (avsResultCode.equalsIgnoreCase("Unsupported") || avsResultCode.equalsIgnoreCase("No Value Returned")) {
                result = "AVS not supported or there was no AVS data provided";
            } else {
                // Java cannot switch on a string so turn everything to a char
                char input = avsResultCode.charAt(0);
...
%>  <!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01 Transitional//EN'>
    ...
    <table width="75%" align='center' cellpadding='5' border='0'>
        ...
        <tr>
            <td colspan='2' align='center'><font color='#C1C1C1'>Fields above are the primary request values.<br/><hr/>
...
%>        <tr>
            <td colspan='2' align='center'><font color='#C1C1C1'><hr/>
...
%>
        ...
        <tr>
            <td colspan='2' align='center'><font color='#C1C1C1'>Fields above are for Standard Transactions<br/><hr/>
