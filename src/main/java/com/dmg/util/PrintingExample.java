...
import com.vaadin.ui.VerticalLayout;
	...
	public class PrintingExample extends CustomComponent  {
	    ...
	    public static class PrintUI extends UI {
	        ...
	        protected void init(VaadinRequest request) {
	            ...
	            setContent(new Label(
	                "<h>Here's some dynamic content</h>\n" +
	    ...
	    void printOpenedPage () {
	        ...
	        opener.setFeatures("height=,width=,resizable");
	    ...
	    void printNonblockingPage () {
	        ...
	        print.addClickListener(new Button.ClickListener() {
	            ...
	            public void buttonClick(ClickEvent event) {
	                ...
	                String content = "<h>Stuff to Print</h>\\n" +
	                                 "<p>Important stuff</p>\\n";
	                ...
	                String js = "popup = window.open('', 'mywindow','status=,width=,height=');\n" +
	    ...
	    public final static String pdfgenerationDescription =
	        "<h>Generating a Printable PDF</h>" +
	    ...
	    class MyPdfSource implements StreamSource {
	        ...
	        public InputStream getStream() {
	            ...
	            String fo = "<?xml version='.' encoding='ISO--'?>\n"+
	            "<fo:root xmlns:fo='http://www.w.org//XSL/Format'>\n"+
	            "<fo:layout-master-set>"+
	            "  <fo:simple-page-master master-name='A' margin='cm'>"+
	            "    <fo:region-body />"+
